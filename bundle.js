(function () {
  ...
  var pieces = [[[0, 1, 0], [1, 1, 1], [0, 0, 0]], //T
  [[1, 1, 1, 1], [0, 0, 0, 0]], //I
  [[0, 1, 1], [1, 1, 0], [0, 0, 0]], //S
  [[1, 1, 0], [0, 1, 1], [0, 0, 0]], //Z
  [[0, 0, 1], [1, 1, 1], [0, 0, 0]], //L
  ...
  function () {
    ...
    _createClass(Renderer, [{
      ...
      value: function renderMap(map) {
        ...
        this.ctx.fillStyle = this.style.map;
  ...
  function () {
    ...
    _createClass(DisplayArea, [{
      ...
      value: function clear() {
        this.ctx.fillStyle = this.style.background;
        this.ctx.fillRect(0, 0, this.area.width * this.cellSize, this.area.height * this.cellSize);
      }
    }, {
      key: "displayItem",
  ...
  var tetrisLastScoreElt = document.querySelector(".js-tetrisLastScore");
  var tetrisHighScoresElt = document.querySelector(".js-tetrisHighScores");
  var snakeHighScores = [];
  var snakeScore = 0;
  var snakeScoreElt = document.querySelector(".js-snakeScore");
  var snakeLastScoreElt = document.querySelector(".js-snakeLastScore");
  var snakeHighScoresElt = document.querySelector(".js-snakeHighScores");
  ...
  function compareScore(a, b) {
    if (a.value === b.value) {
      return b.other.value - a.other.value;
    } else {
  ...
  function onGameOver() {
    ...
    tetrisLastScoreElt.innerHTML = tetrisScore;
    var tetrisLast = {
      value: tetrisScore,
      other: {
        name: "snake",
    ...
    snakeLastScoreElt.innerHTML = snakeScore;
    var snakeLast = {
      value: snakeScore,
      other: {
        name: "tetris",
    ...
    snakeHighScores.push(snakeLast);
    snakeHighScores = snakeHighScores.sort(compareScore).slice(0, 5);
    displayHighScores(snakeHighScoresElt, snakeHighScores, snakeLast);
    saveScores();
  ...
  var tetrisScoreField = document.querySelector(".tetrisScore");
  ...
  var snakeScoreField = document.querySelector(".snakeScore");
  ...
  function displayHighScores(elt, highScores, last) {
    elt.innerHTML = highScores.map(function (s, i) {
      return "<li ".concat(s === last ? 'class="last"' : '', ">\n<span class=\"hightscore-rank\">").concat(i + 1, "</span>\n<span class=\"highscore-date\">").concat(s.date, "</span>\n<span class=\"hightscore-value\">").concat(s.value, " &nbsp;(").concat(s.other.name, ":").concat(s.other.value, ")</span>\n</li>");
    }).join("");
  }

  retreiveScores();
  displayHighScores(tetrisHighScoresElt, tetrisHighScores, undefined);
  displayHighScores(snakeHighScoresElt, snakeHighScores, undefined);
  start();
